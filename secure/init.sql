...
INSERT INTO stores (id, Category, Name, Address, Description, Hours, Price) VALUES (6, 'Specialty Clothing','Platos Closet', '106 Fairgrounds Memorial Pkwy #500, Ithaca', 'Platos caters to teenagers and young adults, so the brands and styles provided are well suited for college students looking for trendy, current pieces! They also buy everyday and pay on the spot.', 'Mon-Sat 10AM-9PM. Sun 11AM-6PM.', '$');
...
INSERT INTO stores (id, Category, Name, Address, Description, Hours, Price) VALUES (8, 'Specialty Clothing','Mary Durham Boutique', 'Ithaca Commons, 110 W Court St.', 'The place to go for colorful and quality womens clothing. Locate in a converted Victorian house to add to the ambience, the boutique help support Womens Opportunity Centers programs.', 'Mon-Thu 10AM-5PM. Fri 10AM-6PM. Sat 10AM-4PM.', '$$');
